function [move,theta_mat,theta_d_mat] = T_sliding_model_controller(i,j,dt,x_mat,y_mat,x_d_mat,y_d_mat,theta_mat,theta_d_mat)
...
%         theta = theta + dtheta*dt;
 ...
 %姿态子控制器
   ...
   s_theta = e_theta ;
   %控制输入
   u_theta =dtheta_d - k3*s_theta-ksi*abs(s_theta)^alpha*sign(s_theta);
   %更新ddtheta
